...
(function(){
  ...
  cartBtn.forEach(function(btn){
      btn.addEventListener("click",function(event){
          ...
          <img src="${item.img}" class="img-fluid rounded-circle" style='height:60px; width:60px' id="item-img" alt="">
          <div class="item-text">

            <p id="cart-item-title" class="font-weight-bold mb-0">cart item</p>
            <span>${item.name} -</span>
            <span id="cart-item-price" class="cart-item-price" class="mb-0">${item.price} FCFA</span>
          </div>
